...
router.post('/user_povar', async (req, res) => {
  try {
    ...
    const query =
      'INSERT INTO user_povar (user_id, deskription, expertise, place, is_prepared) VALUES ($1, $2, $3, $4, $5) RETURNING *';
    const values = [user_id, deskription, expertise, place, is_prepared];
